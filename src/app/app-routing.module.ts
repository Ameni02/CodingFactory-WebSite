...
const routes: Routes = [
  ...
  { path: 'clients', redirectTo: 'pfe-space/clients', pathMatch: 'full' },
  { path: 'matchconsultant', redirectTo: 'pfe-space/matchconsultant', pathMatch: 'full' },

  { path: 'clients/add', redirectTo: 'pfe-space/clients/add', pathMatch: 'full' },
  { path: 'consultation-request/:clientId', redirectTo: 'pfe-space/consultation-request/:clientId' },
